    ...
    <form className='flex flex-col sm:flex-row gap-4'>
        <div className='flex flex-col gap-4 flex-1 '>
            ...
            <div className='flex flex-wrap gap-6'>
                ...
                <div className='flex items-center gap-2'>
                    <input type='number' id='discountPrice' min='1' max='10' required className='p-3 border border-black rounded-lg' />
                    <div className='flex flex-col items-center'>
        ...
        <div className='flex flex-col flex-1 gap-4'>
            ...
            <div className='flex gap-4'>
                ...
                <button type="button" disabled={uploading} onClick={handleImageSubmit} className='p-3 text-green-800 border border-green-700 rounded uppercase hover:shadow-lg disabled:opacity-65 '>{uploading ? 'Uploading...':'Upload'}</button>
            ...
            <button className='p-3 bg-red-600 text-white rounded-lg uppercase hover:opacity-85 disabled:opacity-70 '>Create Listing</button>
        </div>
