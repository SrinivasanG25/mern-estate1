...
export default function Profile() {
  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <button onClick={handleShowListings} className='bg-gradient-to-r from-blue-500 to-green-500 hover:from-blue-700 hover:to-green-700 text-white font-bold p-3 py-2 px-4 rounded w-full'>
        Show Listings
      </button>
